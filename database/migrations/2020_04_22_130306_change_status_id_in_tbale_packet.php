...
class ChangeStatusIdInTbalePacket extends Migration
{
    ...
    public function up()
    {
        $this->changeStatusId(Packet::PACKET_STOL_1, UserStatus::STOL_1);
        $this->changeStatusId(Packet::PACKET_STOL_2, UserStatus::AGENT);
        $this->changeStatusId(Packet::PACKET_STOL_3, UserStatus::MANAGER);
        $this->changeStatusId(Packet::PACKET_STOL_4, UserStatus::MANAGER);
    ...
    public function correctAllStatusesId()
    {
        ...
        foreach ($users as $user) {
            ...
            if (!empty($maxUserPacketIds)) {
                ...
                if ($maxUserPacketId == Packet::PACKET_STOL_1) {
                    $status_id = UserStatus::STOL_1;
                } elseif ($maxUserPacketId == Packet::PACKET_STOL_2) {
                    $status_id = UserStatus::AGENT;
                } elseif ($maxUserPacketId == Packet::PACKET_STOL_3) {
                    $status_id = UserStatus::MANAGER;
                } elseif ($maxUserPacketId == Packet::PACKET_STOL_4) {
                    $status_id = UserStatus::MANAGER;
                } elseif ($maxUserPacketId == Packet::PACKET_STOL_4) {
                    $status_id = UserStatus::MANAGER;
                } else {
