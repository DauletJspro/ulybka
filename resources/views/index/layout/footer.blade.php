        ...
        <div class="footer-widgets">
          <div class="col-md-6 col-sm-6">
            <div id="text-2" class="widget widget_text">
                ...
                <a href="/"  style="">
                  <img class="logo_svg white" style="width: 223px" data-src="/logo_footer.png?v=2" src="/logo_footer.png?v=2" alt="thumb">
                </a></div>
            </div>
          ...
          <div class="col-md-3 col-sm-6">
            <div id="text-3" class="widget widget_text">
              ...
              <ul class="themesflat-shortcode-socials">
                <li class="facebook">
                  <a href="https://www.facebook.com/QyranPartners/" target="_blank" rel="alternate" title="&quot;#&quot;">
            ...
            <div class="col-md-3 col-sm-6">
                <div id="text-5" class="widget widget_text">
                    ...
                    <div class="textwidget">
                        <div class="company-description">
                            <p><p>{{Lang::get('app.footer_address')}}</p></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
          ...
          <div class="copyright">
            <p> <i class="fa fa-copyright"></i>
              2020 <a href="/">go_diamond.kz </a>. Все права защищены.</p>
          </div>
