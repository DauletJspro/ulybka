<?php
$binary_structures = \App\Models\BinaryStructure::all();
?>
<ul class="sidebar-menu">
    ...
    <li class="header" style="padding:5px 25px 0px">
        @if(Auth::user()->is_valid_document == 1)
            <p style="color:#009551;margin:0px 0px 10px 0px; font-size: 14px; font-weight: bold;">Верификация:
                Пройдено</p>
        @else
            <a style="color:#009551;margin:0px 0px 10px 0px; padding: 0px; font-size: 14px; font-weight: bold;"
    ...
    <li class="treeview">
        <a href="/admin/structure">
            ...
            <span>Классическая структура</span>
        </a>
    </li>
    ...
    <li class="treeview">
        <a href="#">
            <i class="fa fa-sitemap"></i>
            <?php $user_packet_notice = \App\Models\UserRequest::where('is_accept', '0')->count();?>
            <span>Матричная структура</span> <i class="fa fa-angle-left pull-right"></i>
