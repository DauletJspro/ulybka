...
class SmartPayController extends Controller
{
    ...
    {
        $actualPackets = [Packet::PACKET_STOL_1, Packet::PACKET_STOL_2, Packet::PACKET_STOL_3, Packet::PACKET_STOL_4, Packet::PACKET_STOL_5, Packet::PACKET_STOL_6, Packet::PACKET_STOL_7];
        $boolean = false;       
